  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      >
        ...
        {/* Notice Info */}
        <div className="flex items-center gap-2.5 px-4 py-3 rounded-xl bg-orange-500/5 border border-orange-500/15 text-orange-700 dark:text-orange-300 text-xs">
          <Sparkles className="w-4 h-4 shrink-0 text-orange-500" />
          <span>
            Cài đặt được lưu tự động trên trình duyệt và áp dụng đồng bộ cho tất cả các bài học.
          </span>
        </div>
